...
#include "../../Features/Visuals/Trails/Trails.h"
...
void CEventListener::FireGameEvent(IGameEvent* pEvent)
{
	...
	{
		// Re-register the 250e8 trail mod search path before the engine reads
		// particles_manifest.txt for the new map.  No-op if checkbox is off.
		F::Trails.Load();
		return;
	}
