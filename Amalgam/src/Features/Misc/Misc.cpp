...
void CMisc::PlayHitsound()
{
	if (!Vars::Misc::Hitsound::Enabled.Value || !Vars::Misc::Hitsound::Sound.Value)
		return;

	const char* sSound = nullptr;
	switch (Vars::Misc::Hitsound::Sound.Value)
	{
	case 1: sSound = "aimbooster.wav"; break;
	case 2: sSound = "ben.wav"; break;
	case 3: sSound = "bonk.wav"; break;
	case 4: sSound = "brotato.wav"; break;
	case 5: sSound = "click.wav"; break;
	case 6: sSound = "kick.wav"; break;
	case 7: sSound = "money claim.wav"; break;
	case 8: sSound = "mouthsound.wav"; break;
	case 9: sSound = "pop.wav"; break;
	case 10: sSound = "quaver.wav"; break;
	case 11: sSound = "regulus.wav"; break;
	case 12: sSound = "satisfying click.wav"; break;
	case 13: sSound = "spiral knight.wav"; break;
	case 14: sSound = "tavern misc1c.wav"; break;
	case 15: sSound = "ting.wav"; break;
	case 16: sSound = "trident pierce.wav"; break;
	case 17: sSound = "water drop.wav"; break;
	case 18: sSound = "zelda.wav"; break;
	case 19: sSound = "[minecraft] XP gain.wav"; break;
	case 20: sSound = "[minecraft] bow ding.wav"; break;
	case 21: sSound = "[minecraft] button.wav"; break;
	case 22: sSound = "[minecraft] egg throw.wav"; break;
	case 23: sSound = "[minecraft] hitsound.wav"; break;
	case 24: sSound = "[minecraft] old hitsound.wav"; break;
	}

	if (sSound)
	{
		std::string sPath = std::format(R"(C:\Users\ludwi\Documents\Neverlose.cc-hitsounds-main\Neverlose.cc-hitsounds-main\wav\{})", sSound);
		PlaySoundA(sPath.c_str(), NULL, SND_ASYNC | SND_FILENAME);
	}
}
...
void CMisc::Event(IGameEvent* pEvent, uint32_t uHash)
{
	...
	case FNV1A::Hash32Const("player_hurt"):
	{
		if (I::EngineClient->GetPlayerForUserID(pEvent->GetInt("attacker")) != I::EngineClient->GetLocalPlayer()
			|| I::EngineClient->GetPlayerForUserID(pEvent->GetInt("userid")) == I::EngineClient->GetLocalPlayer())
			return;
